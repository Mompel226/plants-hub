...
window.STAGES = [
  ...
  { id: 'shoot', n: 3, title: 'The shoot finds the light', chip: 'Shoot',
    ...
    stations: [{ id: 'tropisms', n: 9, title: 'Bending to the light' }], topics: ['14.5'] },
  ...
  { id: 'stem', n: 4, title: 'The stem carries', chip: 'Stem',
    ...
    stations: [{ id: 'stem', n: 3, title: 'Xylem and phloem' }, { id: 'translocation', n: 8, title: 'Sugar on the move' }], topics: ['8.1', '8.4'] },
  ...
  { id: 'water', n: 6, title: 'Water up, water out', chip: 'Water',
    ...
    stations: [{ id: 'transpiration', n: 6, title: 'Water up, water out' }, { id: 'potometer', n: 7, title: 'The potometer' }], topics: ['8.3'] },
  ...
  { id: 'flower', n: 7, title: 'The flower', chip: 'Flower',
    ...
    stations: [{ id: 'flower', n: 10, title: 'The flower' }], topics: ['16.3'] },
  ...
  { id: 'fruit', n: 8, title: 'Fruit and seed', chip: 'Fruit',
    ...
    stations: [{ id: 'fruit', n: 11, title: 'From flower to seed' }], topics: ['16.3'] },
  ...
  { id: 'adapted', n: 9, title: 'Built for its place', chip: 'Adapted',
    ...
    stations: [{ id: 'adapted', n: 12, title: 'Built for its place' }], topics: ['18.2'] }
];
