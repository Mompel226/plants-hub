/* ============================================================
   ...
   detail  a short fact shown on an open lab, e.g. "11 stations · 80 questions"
...
window.TOPICS = [
  { id: 'nutrition', no: 6, year: 'Y11', title: 'Plant nutrition', lab: 'Plants Lab',
    ...
    detail: 'Stations 4 and 5', status: 'live', url: 'https://mompel226.github.io/plants-lab/#leaf' },

  { id: 'transport', no: 8, year: 'Y11', title: 'Transport in plants', lab: 'Plants Lab',
    part: 'stem', stage: 'water',
    blurb: 'Root hairs and the way water gets in, xylem and phloem and where they sit, transpiration and what pulls water up a tree, and sugar on the move from sources to sinks.',
    detail: 'Stations 2, 3, 6 and 7', status: 'live', url: 'https://mompel226.github.io/plants-lab/#root' },
  ...
  { id: 'tropic', no: '14.5', year: 'Y11', title: 'Tropic responses', lab: 'Plants Lab',
    ...
    detail: 'Station 8', status: 'live', url: 'https://mompel226.github.io/plants-lab/#tropisms' },
  ...
  { id: 'reproduction', no: '16.3', year: 'Y11', title: 'Sexual reproduction in plants', lab: 'Plants Lab',
    ...
    detail: 'Stations 1, 9 and 10', status: 'live', url: 'https://mompel226.github.io/plants-lab/#flower' },
  ...
  { id: 'adaptive', no: '18.2', year: 'Y11', title: 'Adaptive features', lab: 'Plants Lab',
    ...
    detail: 'Station 11', status: 'live', url: 'https://mompel226.github.io/plants-lab/#adapted' }
];
